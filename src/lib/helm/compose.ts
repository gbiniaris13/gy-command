...
CREW NAMES RULE (hard): NEVER write a crew member's personal name anywhere (not in the description, not in the inside info, not in the crew line). Crew changes are the owner's prerogative; a named person is a promise we cannot make. Refer to roles only: "the chef", "a crew of three".
