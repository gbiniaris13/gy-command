...
export default function LoginPage() {
  ...
  useEffect(() => {
    // If returning from Gmail OAuth, check if already logged in and redirect
    ...
    return (
      <div className="flex min-h-screen items-center justify-center" style={{ background: "#050A12" }}>
        <div className="text-center">
          ...
          <p style={{ color: "#00F0FF", fontFamily: "var(--font-space-grotesk, sans-serif)" }}>
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border px-8 py-12 shadow-2xl" style={{ borderColor: "rgba(0,240,255,0.1)", background: "#0A1628" }}>
          <div className="mb-10 text-center">
            <h1 className="text-2xl font-bold tracking-[0.25em]" style={{ color: "#00F0FF", fontFamily: "var(--font-space-grotesk, sans-serif)" }}>
              GEORGE YACHTS
            </h1>
          ...
          <button
            ...
            style={{ background: "#00F0FF", color: "#050A12" }}
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none">
              ...
              <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18A10.96 10.96 0 001 12c0 1.77.42 3.45 1.18 4.93l3.66-2.84z" fill="#050A12" />
